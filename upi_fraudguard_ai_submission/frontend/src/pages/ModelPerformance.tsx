                  ...
                  return (
                    <tr 
                      ...
                      className={`hover:bg-dark-border/10 transition ${
                        isSelected ? "bg-brand-primary/5 font-semibold border-l-4 border-l-brand-primary" : ""
                      }`}
                    >
                      ...
                      <td className="px-5 py-3.5 text-right">
                        {isSelected ? (
                          ...
                          <button
                            ...
                            className="bg-brand-primary hover:bg-brand-primary/80 text-white text-xs font-bold px-2.5 py-1 rounded transition hover:scale-[1.05]"
                          >
                            Activate
                          </button>
                        )}

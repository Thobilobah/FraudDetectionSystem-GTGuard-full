...
from backend.app.routes import prediction, analytics, razorpay, transactions
...
# Include Routers directly at root to match specified endpoint paths
app.include_router(prediction.router, tags=["Prediction & Demo"])
app.include_router(analytics.router, tags=["Analytics"])
app.include_router(razorpay.router, tags=["Razorpay Integration"])
app.include_router(transactions.router, tags=["Transactions Log"])
...
def feature_explanation():
    return {
        "transaction_amount": "The amount in INR for the current transaction.",
